...
from mmdet.core import (anchor_inside_flags, force_fp32, images_to_levels, multi_apply,
                        multiclass_nms, unmap, vectorize_labels, giou, iou)
...
class PAPLossRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(PAPLossRetinaHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def loss(self,
        ...
        input_cls_scores = cls_scores
        input_bbox_preds = bbox_preds
...
class GradScale(torch.autograd.Function):
    ...
    def forward(ctx, cls_scores, bbox_preds, reg_weight):
        GradScale.weight = reg_weight
        return cls_scores, bbox_preds
    
    @staticmethod
    def backward(ctx, grad_cls, grad_bbox):
        return grad_cls, GradScale.weight * grad_bbox, None